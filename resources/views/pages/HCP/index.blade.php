            ...
            <div class="row news-posts-insert loading-6">
                <div class="col-sm-4 col-xs-12 news-item text-center">
                    <div class="animated-wave">
                        <a href="{{ url($pageClass) }}/cftr-science/cftr-mutations">
                ...
                <div class="col-sm-4 col-xs-12 news-item text-center">
                    <div class="animated-wave">
                        <a href="{{ url($pageClass) }}/cftr-science/genotype-and-phenotype">
                ...
                <div class="col-sm-4 col-xs-12 news-item text-center">
                    <div class="animated-wave">
                        <a href="{{ url($pageClass) }}/cftr-science/scientific-resources">
